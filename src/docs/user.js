 ...
 *    description: Revisa a partir del "email" y "password" si hay un usuario registrado con esas credenciales, en caso de que sea así devuelve una cookie de autorizacion.
 *    tags: [User]
 *    requestBody:
 *      required: true
 *      content:
